...
/* ===== VERBOS · lote 2 (comunicação, rotina, movimento, processo, objetos) ===== */
{id:"v_hablar",type:"verb",tag:"b",word:"hablar",gloss:"falar",sentences:[{es:"No hablo inglés.",pt:"Não falo inglês.",target:"hablo"},{es:"¿Hablamos luego?",pt:"A gente fala depois?",target:"Hablamos"}]},
{id:"v_oir",type:"verb",tag:"b",word:"oír",gloss:"ouvir",sentences:[{es:"No te oigo bien.",pt:"Não te ouço bem.",target:"oigo"}]},
{id:"v_escuchar",type:"verb",tag:"b",word:"escuchar",gloss:"escutar",sentences:[{es:"Escucho música en el tren.",pt:"Escuto música no trem.",target:"Escucho"}]},
{id:"v_mirar",type:"verb",tag:"b",word:"mirar",gloss:"olhar",sentences:[{es:"Mira esto.",pt:"Olha isso.",target:"Mira"}]},
{id:"v_leer",type:"verb",tag:"b",word:"leer",gloss:"ler",sentences:[{es:"Leo antes de dormir.",pt:"Leio antes de dormir.",target:"Leo"}]},
{id:"v_escribir",type:"verb",tag:"b",word:"escribir",gloss:"escrever",sentences:[{es:"Te escribo un correo.",pt:"Te escrevo um e-mail.",target:"escribo"}]},
{id:"v_contar",type:"verb",tag:"g",word:"contar",gloss:"contar (narrar / números)",sentences:[{es:"Te cuento un secreto.",pt:"Te conto um segredo.",target:"cuento"}]},
{id:"v_explicar",type:"verb",tag:"g",word:"explicar",gloss:"explicar",sentences:[{es:"¿Me lo explicas?",pt:"Você me explica?",target:"explicas"}]},
{id:"v_mostrar",type:"verb",tag:"a",word:"mostrar",gloss:"mostrar",sentences:[{es:"Te muestro las fotos.",pt:"Te mostro as fotos.",target:"muestro"}]},
{id:"v_responder",type:"verb",tag:"g",word:"responder",gloss:"responder",sentences:[{es:"No respondió al correo.",pt:"Não respondeu o e-mail.",target:"respondió"}]},
{id:"v_ensenar",type:"verb",tag:"b",word:"enseñar",gloss:"ensinar / mostrar",note:"🔵 enseñar = ensinar E mostrar (te enseño la casa = te mostro a casa).",sentences:[{es:"Te enseño la casa.",pt:"Te mostro a casa.",target:"enseño"}]},
{id:"v_comer",type:"verb",tag:"g",word:"comer",gloss:"comer",sentences:[{es:"¿Qué comemos hoy?",pt:"O que a gente come hoje?",target:"comemos"}]},
{id:"v_beber",type:"verb",tag:"g",word:"beber",gloss:"beber",sentences:[{es:"Bebe más agua.",pt:"Bebe mais água.",target:"Bebe"}]},
{id:"v_cocinar",type:"verb",tag:"b",word:"cocinar",gloss:"cozinhar",sentences:[{es:"Cocino los domingos.",pt:"Cozinho aos domingos.",target:"Cocino"}]},
{id:"v_limpiar",type:"verb",tag:"b",word:"limpiar",gloss:"limpar",sentences:[{es:"Limpio la casa el sábado.",pt:"Limpo a casa no sábado.",target:"Limpio"}]},
{id:"v_lavar",type:"verb",tag:"g",word:"lavar",gloss:"lavar",sentences:[{es:"Lavo los platos.",pt:"Lavo os pratos.",target:"Lavo"}]},
{id:"v_dormir",type:"verb",tag:"a",word:"dormir",gloss:"dormir",sentences:[{es:"Duermo ocho horas.",pt:"Durmo oito horas.",target:"Duermo"}]},
{id:"v_despertarse",type:"verb",tag:"b",word:"despertarse",gloss:"acordar (do sono)",note:"🔵 despertarse = acordar do sono. «Acordar-se» (lembrar) é <span class='es'>acordarse</span>.",sentences:[{es:"Me despierto temprano.",pt:"Acordo cedo.",target:"despierto"}]},
{id:"v_levantarse",type:"verb",tag:"b",word:"levantarse",gloss:"levantar-se",sentences:[{es:"Me levanto a las siete.",pt:"Levanto às sete.",target:"levanto"}]},
{id:"v_sentarse",type:"verb",tag:"b",word:"sentarse",gloss:"sentar-se",sentences:[{es:"Siéntate aquí.",pt:"Senta aqui.",target:"Siéntate"}]},
{id:"v_acostarse",type:"verb",tag:"b",word:"acostarse",gloss:"deitar-se",sentences:[{es:"Me acuesto tarde.",pt:"Deito tarde.",target:"acuesto"}]},
{id:"v_ducharse",type:"verb",tag:"b",word:"ducharse",gloss:"tomar banho",sentences:[{es:"Me ducho por la mañana.",pt:"Tomo banho de manhã.",target:"ducho"}]},
{id:"v_comprar",type:"verb",tag:"b",word:"comprar",gloss:"comprar",sentences:[{es:"Compro pan cada día.",pt:"Compro pão todo dia.",target:"Compro"}]},
{id:"v_vender",type:"verb",tag:"g",word:"vender",gloss:"vender",sentences:[{es:"Venden fruta aquí.",pt:"Vendem fruta aqui.",target:"Venden"}]},
{id:"v_descansar",type:"verb",tag:"b",word:"descansar",gloss:"descansar",sentences:[{es:"Necesito descansar.",pt:"Preciso descansar.",target:"descansar"}]},
{id:"v_estudiar",type:"verb",tag:"a",word:"estudiar",gloss:"estudar",sentences:[{es:"Estudio español todos los días.",pt:"Estudo espanhol todo dia.",target:"Estudio"}]},
{id:"v_trabajar",type:"verb",tag:"b",word:"trabajar",gloss:"trabalhar",sentences:[{es:"Trabajo desde casa.",pt:"Trabalho de casa.",target:"Trabajo"}]},
{id:"v_llegar",type:"verb",tag:"b",word:"llegar",gloss:"chegar",sentences:[{es:"Llego tarde, lo siento.",pt:"Chego tarde, desculpa.",target:"Llego"}]},
{id:"v_entrar",type:"verb",tag:"g",word:"entrar",gloss:"entrar",sentences:[{es:"Entra, está abierto.",pt:"Entra, está aberto.",target:"Entra"}]},
{id:"v_subir",type:"verb",tag:"b",word:"subir",gloss:"subir / aumentar",note:"🔵 subir = subir E aumentar (han subido los precios).",sentences:[{es:"Sube por las escaleras.",pt:"Sobe pela escada.",target:"Sube"},{es:"Han subido los precios.",pt:"Os preços subiram.",target:"subido"}]},
{id:"v_bajar",type:"verb",tag:"b",word:"bajar",gloss:"descer / baixar / diminuir",note:"🔵 bajar = descer, baixar (arquivo) e diminuir.",sentences:[{es:"Baja el volumen.",pt:"Abaixa o volume.",target:"Baja"},{es:"Voy a bajar la app.",pt:"Vou baixar o aplicativo.",target:"bajar"}]},
{id:"v_correr",type:"verb",tag:"g",word:"correr",gloss:"correr",sentences:[{es:"Corro cada mañana.",pt:"Corro toda manhã.",target:"Corro"}]},
{id:"v_andar",type:"verb",tag:"a",word:"andar",gloss:"andar / caminhar",sentences:[{es:"Ando mucho por el centro.",pt:"Ando muito pelo centro.",target:"Ando"}]},
{id:"v_caminar",type:"verb",tag:"b",word:"caminar",gloss:"caminhar",sentences:[{es:"Caminamos por el parque.",pt:"Caminhamos pelo parque.",target:"Caminamos"}]},
{id:"v_viajar",type:"verb",tag:"b",word:"viajar",gloss:"viajar",sentences:[{es:"Viajo mucho por trabajo.",pt:"Viajo muito a trabalho.",target:"Viajo"}]},
{id:"v_seguir",type:"verb",tag:"a",word:"seguir",gloss:"seguir / continuar",note:"🟡 <span class='es'>seguir + gerúndio</span> = continuar (sigo trabajando = continuo trabalhando).",sentences:[{es:"Sigo trabajando aquí.",pt:"Continuo trabalhando aqui.",target:"Sigo"}]},
{id:"v_parar",type:"verb",tag:"a",word:"parar",gloss:"parar",sentences:[{es:"Para aquí, por favor.",pt:"Para aqui, por favor.",target:"Para"}]},
{id:"v_cambiar",type:"verb",tag:"b",word:"cambiar",gloss:"mudar / trocar",sentences:[{es:"Quiero cambiar de trabajo.",pt:"Quero mudar de trabalho.",target:"cambiar"}]},
{id:"v_mejorar",type:"verb",tag:"b",word:"mejorar",gloss:"melhorar",sentences:[{es:"Quiero mejorar mi español.",pt:"Quero melhorar meu espanhol.",target:"mejorar"}]},
{id:"v_crecer",type:"verb",tag:"b",word:"crecer",gloss:"crescer",sentences:[{es:"Los niños crecen rápido.",pt:"As crianças crescem rápido.",target:"crecen"}]},
{id:"v_creer",type:"verb",tag:"b",word:"creer",gloss:"crer / achar",sentences:[{es:"Creo que sí.",pt:"Acho que sim.",target:"Creo"}]},
{id:"v_parecer",type:"verb",tag:"g",word:"parecer",gloss:"parecer",sentences:[{es:"Me parece bien.",pt:"Me parece bem.",target:"parece"}]},
{id:"v_sentir",type:"verb",tag:"g",word:"sentir",gloss:"sentir / lamentar",note:"🟢 <span class='es'>lo siento</span> = sinto muito / desculpa.",sentences:[{es:"Lo siento mucho.",pt:"Sinto muito.",target:"siento"},{es:"Me siento mal.",pt:"Me sinto mal.",target:"siento"}]},
{id:"v_recordar",type:"verb",tag:"a",word:"recordar",gloss:"lembrar (de algo)",sentences:[{es:"No recuerdo su nombre.",pt:"Não lembro o nome dele.",target:"recuerdo"}]},
{id:"v_olvidar",type:"verb",tag:"b",word:"olvidar",gloss:"esquecer",sentences:[{es:"Olvidé las llaves.",pt:"Esqueci as chaves.",target:"Olvidé"}]},
{id:"v_aprender",type:"verb",tag:"g",word:"aprender",gloss:"aprender",sentences:[{es:"Aprendo rápido.",pt:"Aprendo rápido.",target:"Aprendo"}]},
{id:"v_preocuparse",type:"verb",tag:"b",word:"preocuparse",gloss:"preocupar-se",sentences:[{es:"No te preocupes.",pt:"Não se preocupa.",target:"preocupes"}]},
{id:"v_reir",type:"verb",tag:"b",word:"reír",gloss:"rir",sentences:[{es:"Nos reímos mucho.",pt:"A gente ri muito.",target:"reímos"}]},
{id:"v_llorar",type:"verb",tag:"b",word:"llorar",gloss:"chorar",sentences:[{es:"El bebé llora.",pt:"O bebê chora.",target:"llora"}]},
{id:"v_disfrutar",type:"verb",tag:"b",word:"disfrutar",gloss:"aproveitar / curtir",sentences:[{es:"Disfruta el viaje.",pt:"Aproveita a viagem.",target:"Disfruta"}]},
{id:"v_doler",type:"verb",tag:"b",word:"doler",gloss:"doer (estrutura tipo gustar)",note:"🔵 <span class='es'>me duele</span> = me dói (estrutura invertida).",sentences:[{es:"Me duele la cabeza.",pt:"Minha cabeça dói.",target:"duele"}]},
{id:"v_importar",type:"verb",tag:"b",word:"importar",gloss:"importar / importar-se",note:"🔵 <span class='es'>no me importa</span> = não me importo; <span class='es'>¿te importa?</span> = você se incomoda?",sentences:[{es:"No me importa.",pt:"Não me importo.",target:"importa"}]},
{id:"v_vivir",type:"verb",tag:"a",word:"vivir",gloss:"viver / morar",sentences:[{es:"Vivo en Madrid.",pt:"Moro em Madri.",target:"Vivo"}]},
{id:"v_morir",type:"verb",tag:"b",word:"morir",gloss:"morrer",sentences:[{es:"Mi abuelo murió el año pasado.",pt:"Meu avô morreu ano passado.",target:"murió"}]},
{id:"v_nacer",type:"verb",tag:"b",word:"nacer",gloss:"nascer",sentences:[{es:"Nací en Brasil.",pt:"Nasci no Brasil.",target:"Nací"}]},
{id:"v_abrir",type:"verb",tag:"g",word:"abrir",gloss:"abrir",sentences:[{es:"Abre la ventana.",pt:"Abre a janela.",target:"Abre"}]},
{id:"v_cerrar",type:"verb",tag:"b",word:"cerrar",gloss:"fechar",sentences:[{es:"Cierra la puerta.",pt:"Fecha a porta.",target:"Cierra"}]},
{id:"v_romper",type:"verb",tag:"b",word:"romper",gloss:"quebrar / rasgar",sentences:[{es:"Rompí el vaso.",pt:"Quebrei o copo.",target:"Rompí"}]},
{id:"v_arreglar",type:"verb",tag:"b",word:"arreglar",gloss:"consertar / arrumar",sentences:[{es:"Voy a arreglar el móvil.",pt:"Vou consertar o celular.",target:"arreglar"}]},
{id:"v_apagar",type:"verb",tag:"g",word:"apagar",gloss:"apagar / desligar",sentences:[{es:"Apaga la luz.",pt:"Apaga a luz.",target:"Apaga"}]},
{id:"v_encender",type:"verb",tag:"b",word:"encender",gloss:"acender / ligar",sentences:[{es:"Enciende la luz.",pt:"Acende a luz.",target:"Enciende"}]},
{id:"v_sacar",type:"verb",tag:"b",word:"sacar",gloss:"tirar (foto/dinheiro/lixo)",note:"🔵 sacar dinero, sacar una foto, sacar la basura — sempre 'tirar/pôr pra fora'.",sentences:[{es:"Saco dinero del cajero.",pt:"Tiro dinheiro do caixa.",target:"Saco"},{es:"Sácame una foto.",pt:"Tira uma foto minha.",target:"Sácame"}]},
{id:"v_meter",type:"verb",tag:"b",word:"meter",gloss:"meter / pôr dentro",sentences:[{es:"Mete la ropa en la maleta.",pt:"Põe a roupa na mala.",target:"Mete"}]},
{id:"v_agarrar",type:"verb",tag:"b",word:"agarrar",gloss:"pegar / segurar",sentences:[{es:"Agarra mi mano.",pt:"Segura minha mão.",target:"Agarra"}]},
{id:"v_guardar",type:"verb",tag:"b",word:"guardar",gloss:"guardar / salvar",note:"🔵 guardar = guardar E salvar (arquivo). Tb. guardar = vigiar.",sentences:[{es:"Guarda el archivo.",pt:"Salva o arquivo.",target:"Guarda"}]},
{id:"v_cortar",type:"verb",tag:"g",word:"cortar",gloss:"cortar",sentences:[{es:"Corta el pan, por favor.",pt:"Corta o pão, por favor.",target:"Corta"}]},
{id:"v_servir",type:"verb",tag:"g",word:"servir",gloss:"servir",sentences:[{es:"¿Para qué sirve?",pt:"Pra que serve?",target:"sirve"}]},
{id:"v_intentar",type:"verb",tag:"b",word:"intentar",gloss:"tentar",sentences:[{es:"Voy a intentarlo.",pt:"Vou tentar.",target:"intentar"}]},
{id:"v_probar",type:"verb",tag:"b",word:"probar",gloss:"provar / experimentar",sentences:[{es:"¿Puedo probarlo?",pt:"Posso experimentar?",target:"probar"}]},
{id:"v_elegir",type:"verb",tag:"b",word:"elegir",gloss:"escolher",sentences:[{es:"Elige tú.",pt:"Escolhe você.",target:"Elige"}]},
{id:"v_conseguir",type:"verb",tag:"a",word:"conseguir",gloss:"conseguir",sentences:[{es:"Conseguí entradas.",pt:"Consegui ingressos.",target:"Conseguí"}]},
{id:"v_recibir",type:"verb",tag:"b",word:"recibir",gloss:"receber",sentences:[{es:"Recibí tu mensaje.",pt:"Recebi sua mensagem.",target:"Recibí"}]},
{id:"v_mandar",type:"verb",tag:"b",word:"mandar",gloss:"mandar / enviar",sentences:[{es:"Te mando la foto.",pt:"Te mando a foto.",target:"mando"}]},
{id:"v_tardar",type:"verb",tag:"b",word:"tardar",gloss:"demorar",sentences:[{es:"Tarda mucho en llegar.",pt:"Demora muito pra chegar.",target:"Tarda"}]},
{id:"v_durar",type:"verb",tag:"g",word:"durar",gloss:"durar",sentences:[{es:"La película dura dos horas.",pt:"O filme dura duas horas.",target:"dura"}]},
{id:"v_tocar",type:"verb",tag:"b",word:"tocar",gloss:"tocar / ser a vez",note:"🔵 <span class='es'>me toca a mí</span> = é a minha vez.",sentences:[{es:"Me toca a mí.",pt:"É a minha vez.",target:"toca"},{es:"Toca la guitarra.",pt:"Ele toca violão.",target:"Toca"}]},
{id:"v_faltar",type:"verb",tag:"b",word:"faltar",gloss:"faltar",note:"🔵 <span class='es'>me falta</span> = me falta (estrutura invertida).",sentences:[{es:"Me falta tiempo.",pt:"Me falta tempo.",target:"falta"}]},
{id:"v_valer",type:"verb",tag:"b",word:"valer",gloss:"custar / valer",note:"🔵 <span class='es'>¿cuánto vale?</span> = quanto custa? (tb. «vale» = ok).",sentences:[{es:"¿Cuánto vale esto?",pt:"Quanto custa isto?",target:"vale"}]},
{id:"v_encontrar",type:"verb",tag:"g",word:"encontrar",gloss:"encontrar / achar",sentences:[{es:"No encuentro mi cartera.",pt:"Não acho minha carteira.",target:"encuentro"}]},
{id:"v_necesitar",type:"verb",tag:"b",word:"necesitar",gloss:"precisar",sentences:[{es:"Necesito ayuda.",pt:"Preciso de ajuda.",target:"Necesito"}]},
{id:"v_usar",type:"verb",tag:"g",word:"usar",gloss:"usar",sentences:[{es:"¿Puedo usar tu móvil?",pt:"Posso usar seu celular?",target:"usar"}]},
{id:"v_jugar",type:"verb",tag:"b",word:"jugar",gloss:"jogar / brincar",note:"🔵 jugar = jogar E brincar (los niños juegan = as crianças brincam).",sentences:[{es:"Los niños juegan fuera.",pt:"As crianças brincam lá fora.",target:"juegan"}]},
{id:"v_ganar",type:"verb",tag:"b",word:"ganar",gloss:"ganhar / vencer",sentences:[{es:"Gano poco dinero.",pt:"Ganho pouco dinheiro.",target:"Gano"}]},
{id:"v_gastar",type:"verb",tag:"b",word:"gastar",gloss:"gastar (dinheiro/tempo)",sentences:[{es:"Gasto mucho en comida.",pt:"Gasto muito com comida.",target:"Gasto"}]},
{id:"v_acabar",type:"verb",tag:"a",word:"acabar",gloss:"acabar / terminar",note:"🟡 <span class='es'>acabar de + inf.</span> = acabar de (acabo de llegar).",sentences:[{es:"Acabo de llegar.",pt:"Acabei de chegar.",target:"Acabo"}]},
{id:"v_preferir",type:"verb",tag:"b",word:"preferir",gloss:"preferir",sentences:[{es:"Prefiero el té al café.",pt:"Prefiro chá a café.",target:"Prefiero"}]},

/* ===== SUBSTANTIVOS · lote 2 ===== */
/* -- Comida & mesa -- */
{id:"n_arroz",type:"noun",tag:"g",word:"el arroz",gloss:"arroz",sentences:[{es:"Arroz con pollo.",pt:"Arroz com frango.",target:"Arroz"}]},
{id:"n_patata",type:"noun",tag:"b",word:"la patata",gloss:"batata (Espanha)",note:"🔵 Na Espanha, patata. Na América, «papa».",sentences:[{es:"Patatas fritas, por favor.",pt:"Batatas fritas, por favor.",target:"Patatas"}]},
{id:"n_tomate",type:"noun",tag:"g",word:"el tomate",gloss:"tomate",sentences:[{es:"Una ensalada de tomate.",pt:"Uma salada de tomate.",target:"tomate"}]},
{id:"n_cebolla",type:"noun",tag:"b",word:"la cebolla",gloss:"cebola",sentences:[{es:"Corta la cebolla.",pt:"Corta a cebola.",target:"cebolla"}]},
{id:"n_ajo",type:"noun",tag:"b",word:"el ajo",gloss:"alho",sentences:[{es:"Pon un poco de ajo.",pt:"Põe um pouco de alho.",target:"ajo"}]},
{id:"n_tortilla",type:"noun",tag:"b",word:"la tortilla",gloss:"omelete / tortilla espanhola",sentences:[{es:"Una tortilla de patatas.",pt:"Uma tortilla de batata.",target:"tortilla"}]},
{id:"n_cafe",type:"noun",tag:"g",word:"el café",gloss:"café",sentences:[{es:"Un café solo, por favor.",pt:"Um café puro, por favor.",target:"café"}]},
{id:"n_te",type:"noun",tag:"b",word:"el té",gloss:"chá",sentences:[{es:"Un té con limón.",pt:"Um chá com limão.",target:"té"}]},
{id:"n_zumo",type:"noun",tag:"b",word:"el zumo",gloss:"suco (Espanha)",note:"🔵 Na Espanha, zumo. Na América, «jugo».",sentences:[{es:"Un zumo de naranja.",pt:"Um suco de laranja.",target:"zumo"}]},
{id:"n_refresco",type:"noun",tag:"b",word:"el refresco",gloss:"refrigerante",sentences:[{es:"¿Quieres un refresco?",pt:"Você quer um refrigerante?",target:"refresco"}]},
{id:"n_hielo",type:"noun",tag:"b",word:"el hielo",gloss:"gelo",sentences:[{es:"Con hielo, por favor.",pt:"Com gelo, por favor.",target:"hielo"}]},
{id:"n_azucar",type:"noun",tag:"a",word:"el azúcar",gloss:"açúcar",sentences:[{es:"Sin azúcar, gracias.",pt:"Sem açúcar, obrigada.",target:"azúcar"}]},
{id:"n_sopa",type:"noun",tag:"g",word:"la sopa",gloss:"sopa",sentences:[{es:"Una sopa caliente.",pt:"Uma sopa quente.",target:"sopa"}]},
{id:"n_ensalada",type:"noun",tag:"b",word:"la ensalada",gloss:"salada",sentences:[{es:"De primero, ensalada.",pt:"De entrada, salada.",target:"ensalada"}]},
{id:"n_manzana",type:"noun",tag:"b",word:"la manzana",gloss:"maçã (tb. quarteirão)",sentences:[{es:"Una manzana al día.",pt:"Uma maçã por dia.",target:"manzana"}]},
{id:"n_naranja",type:"noun",tag:"b",word:"la naranja",gloss:"laranja (fruta e cor)",sentences:[{es:"Un zumo de naranja natural.",pt:"Um suco de laranja natural.",target:"naranja"}]},
{id:"n_platano",type:"noun",tag:"b",word:"el plátano",gloss:"banana",sentences:[{es:"Me como un plátano.",pt:"Como uma banana.",target:"plátano"}]},
{id:"n_helado",type:"noun",tag:"b",word:"el helado",gloss:"sorvete",sentences:[{es:"Un helado de chocolate.",pt:"Um sorvete de chocolate.",target:"helado"}]},
{id:"n_galleta",type:"noun",tag:"b",word:"la galleta",gloss:"biscoito / bolacha",sentences:[{es:"Galletas con leche.",pt:"Biscoitos com leite.",target:"Galletas"}]},
{id:"n_tarta",type:"noun",tag:"b",word:"la tarta",gloss:"bolo / torta",sentences:[{es:"Una tarta de cumpleaños.",pt:"Um bolo de aniversário.",target:"tarta"}]},
{id:"n_botella",type:"noun",tag:"b",word:"la botella",gloss:"garrafa",sentences:[{es:"Una botella de agua.",pt:"Uma garrafa de água.",target:"botella"}]},
{id:"n_servilleta",type:"noun",tag:"b",word:"la servilleta",gloss:"guardanapo",sentences:[{es:"¿Me das una servilleta?",pt:"Me dá um guardanapo?",target:"servilleta"}]},
{id:"n_cuchara",type:"noun",tag:"b",word:"la cuchara",gloss:"colher",sentences:[{es:"Falta una cuchara.",pt:"Falta uma colher.",target:"cuchara"}]},
{id:"n_tenedor",type:"noun",tag:"b",word:"el tenedor",gloss:"garfo",sentences:[{es:"Come con tenedor.",pt:"Come com garfo.",target:"tenedor"}]},
{id:"n_cuchillo",type:"noun",tag:"b",word:"el cuchillo",gloss:"faca",sentences:[{es:"Corta con el cuchillo.",pt:"Corta com a faca.",target:"cuchillo"}]},
/* -- Casa -- */
{id:"n_sofa",type:"noun",tag:"g",word:"el sofá",gloss:"sofá",sentences:[{es:"Descanso en el sofá.",pt:"Descanso no sofá.",target:"sofá"}]},
{id:"n_armario",type:"noun",tag:"b",word:"el armario",gloss:"armário / guarda-roupa",sentences:[{es:"La ropa está en el armario.",pt:"A roupa está no armário.",target:"armario"}]},
{id:"n_cajon",type:"noun",tag:"b",word:"el cajón",gloss:"gaveta",sentences:[{es:"Está en el cajón.",pt:"Está na gaveta.",target:"cajón"}]},
{id:"n_manta",type:"noun",tag:"a",word:"la manta",gloss:"cobertor / manta",note:"Como no PT: manta = cobertor. (Lembrete: «manteiga» é <span class='es'>mantequilla</span>.)",sentences:[{es:"Tengo frío, dame una manta.",pt:"Estou com frio, me dá um cobertor.",target:"manta"}]},
{id:"n_almohada",type:"noun",tag:"b",word:"la almohada",gloss:"travesseiro",sentences:[{es:"La almohada es muy blanda.",pt:"O travesseiro é muito macio.",target:"almohada"}]},
{id:"n_sabana",type:"noun",tag:"b",word:"la sábana",gloss:"lençol",sentences:[{es:"Cambio las sábanas.",pt:"Troco os lençóis.",target:"sábanas"}]},
{id:"n_toalla",type:"noun",tag:"b",word:"la toalla",gloss:"toalha (de banho)",note:"🔵 toalla = toalha de banho/rosto. Toalha de mesa é «mantel».",sentences:[{es:"Una toalla limpia.",pt:"Uma toalha limpa.",target:"toalla"}]},
{id:"n_espejo",type:"noun",tag:"b",word:"el espejo",gloss:"espelho",sentences:[{es:"Me miro en el espejo.",pt:"Me olho no espelho.",target:"espejo"}]},
{id:"n_lampara",type:"noun",tag:"a",word:"la lámpara",gloss:"luminária / abajur",sentences:[{es:"Enciende la lámpara.",pt:"Acende a luminária.",target:"lámpara"}]},
{id:"n_enchufe",type:"noun",tag:"b",word:"el enchufe",gloss:"tomada",sentences:[{es:"¿Dónde hay un enchufe?",pt:"Onde tem uma tomada?",target:"enchufe"}]},
{id:"n_cortina",type:"noun",tag:"g",word:"la cortina",gloss:"cortina",sentences:[{es:"Abre las cortinas.",pt:"Abre as cortinas.",target:"cortinas"}]},
{id:"n_jardin",type:"noun",tag:"b",word:"el jardín",gloss:"jardim / quintal",sentences:[{es:"La casa tiene jardín.",pt:"A casa tem quintal.",target:"jardín"}]},
{id:"n_terraza",type:"noun",tag:"a",word:"la terraza",gloss:"varanda / terraço",sentences:[{es:"Cenamos en la terraza.",pt:"Jantamos na varanda.",target:"terraza"}]},
{id:"n_garaje",type:"noun",tag:"a",word:"el garaje",gloss:"garagem",sentences:[{es:"El coche está en el garaje.",pt:"O carro está na garagem.",target:"garaje"}]},
{id:"n_escalera",type:"noun",tag:"b",word:"la escalera",gloss:"escada",sentences:[{es:"Sube por la escalera.",pt:"Sobe pela escada.",target:"escalera"}]},
{id:"n_jabon",type:"noun",tag:"b",word:"el jabón",gloss:"sabonete / sabão",sentences:[{es:"No hay jabón.",pt:"Não tem sabonete.",target:"jabón"}]},
{id:"n_cepillo",type:"noun",tag:"b",word:"el cepillo",gloss:"escova",sentences:[{es:"El cepillo de dientes.",pt:"A escova de dentes.",target:"cepillo"}]},
/* -- Cidade & viagem -- */
{id:"n_puente",type:"noun",tag:"b",word:"el puente",gloss:"ponte (tb. feriado prolongado)",sentences:[{es:"Cruza el puente.",pt:"Atravessa a ponte.",target:"puente"}]},
{id:"n_colegio",type:"noun",tag:"b",word:"el colegio",gloss:"escola / colégio",sentences:[{es:"Los niños van al colegio.",pt:"As crianças vão à escola.",target:"colegio"}]},
{id:"n_iglesia",type:"noun",tag:"b",word:"la iglesia",gloss:"igreja",sentences:[{es:"Visitamos la iglesia.",pt:"Visitamos a igreja.",target:"iglesia"}]},
{id:"n_parque",type:"noun",tag:"g",word:"el parque",gloss:"parque",sentences:[{es:"Paseo por el parque.",pt:"Passeio pelo parque.",target:"parque"}]},
{id:"n_gasolinera",type:"noun",tag:"b",word:"la gasolinera",gloss:"posto de gasolina",sentences:[{es:"Para en la gasolinera.",pt:"Para no posto.",target:"gasolinera"}]},
{id:"n_aparcamiento",type:"noun",tag:"b",word:"el aparcamiento",gloss:"estacionamento (Espanha)",sentences:[{es:"No hay aparcamiento.",pt:"Não tem estacionamento.",target:"aparcamiento"}]},
{id:"n_maleta",type:"noun",tag:"b",word:"la maleta",gloss:"mala (de viagem)",sentences:[{es:"Hago la maleta.",pt:"Faço a mala.",target:"maleta"}]},
{id:"n_equipaje",type:"noun",tag:"b",word:"el equipaje",gloss:"bagagem",sentences:[{es:"Recojo el equipaje.",pt:"Pego a bagagem.",target:"equipaje"}]},
{id:"n_pasaporte",type:"noun",tag:"a",word:"el pasaporte",gloss:"passaporte",sentences:[{es:"Enséñame el pasaporte.",pt:"Me mostra o passaporte.",target:"pasaporte"}]},
{id:"n_vuelo",type:"noun",tag:"b",word:"el vuelo",gloss:"voo",sentences:[{es:"El vuelo sale a las diez.",pt:"O voo sai às dez.",target:"vuelo"}]},
{id:"n_mapa",type:"noun",tag:"g",word:"el mapa",gloss:"mapa",note:"🔵 Atenção: «el mapa» é masculino.",sentences:[{es:"Mira el mapa.",pt:"Olha o mapa.",target:"mapa"}]},
{id:"n_hotel",type:"noun",tag:"g",word:"el hotel",gloss:"hotel",sentences:[{es:"Reservé un hotel.",pt:"Reservei um hotel.",target:"hotel"}]},
{id:"n_buzon",type:"noun",tag:"b",word:"el buzón",gloss:"caixa de correio",sentences:[{es:"Echa la carta al buzón.",pt:"Põe a carta na caixa de correio.",target:"buzón"}]},
{id:"n_comisaria",type:"noun",tag:"b",word:"la comisaría",gloss:"delegacia",sentences:[{es:"Fui a la comisaría.",pt:"Fui à delegacia.",target:"comisaría"}]},
/* -- Corpo -- */
{id:"n_pelo",type:"noun",tag:"b",word:"el pelo",gloss:"cabelo",sentences:[{es:"Tiene el pelo largo.",pt:"Ela tem o cabelo comprido.",target:"pelo"}]},
{id:"n_diente",type:"noun",tag:"b",word:"el diente",gloss:"dente",sentences:[{es:"Me lavo los dientes.",pt:"Escovo os dentes.",target:"dientes"}]},
{id:"n_muela",type:"noun",tag:"b",word:"la muela",gloss:"dente do fundo / molar",sentences:[{es:"Me duele una muela.",pt:"Um dente do fundo está doendo.",target:"muela"}]},
{id:"n_lengua",type:"noun",tag:"b",word:"la lengua",gloss:"língua",sentences:[{es:"Me mordí la lengua.",pt:"Mordi a língua.",target:"lengua"}]},
{id:"n_labio",type:"noun",tag:"b",word:"el labio",gloss:"lábio",sentences:[{es:"Tengo los labios secos.",pt:"Meus lábios estão secos.",target:"labios"}]},
{id:"n_hombro",type:"noun",tag:"b",word:"el hombro",gloss:"ombro",sentences:[{es:"Me duele el hombro.",pt:"Meu ombro dói.",target:"hombro"}]},
{id:"n_rodilla",type:"noun",tag:"b",word:"la rodilla",gloss:"joelho",sentences:[{es:"Me hice daño en la rodilla.",pt:"Machuquei o joelho.",target:"rodilla"}]},
{id:"n_dedo",type:"noun",tag:"g",word:"el dedo",gloss:"dedo",sentences:[{es:"Me corté el dedo.",pt:"Cortei o dedo.",target:"dedo"}]},
{id:"n_una",type:"noun",tag:"b",word:"la uña",gloss:"unha",sentences:[{es:"Me pinto las uñas.",pt:"Pinto as unhas.",target:"uñas"}]},
{id:"n_piel",type:"noun",tag:"b",word:"la piel",gloss:"pele",sentences:[{es:"Tengo la piel seca.",pt:"Minha pele está seca.",target:"piel"}]},
{id:"n_corazon",type:"noun",tag:"b",word:"el corazón",gloss:"coração",sentences:[{es:"Me late el corazón fuerte.",pt:"Meu coração bate forte.",target:"corazón"}]},
{id:"n_hueso",type:"noun",tag:"b",word:"el hueso",gloss:"osso",sentences:[{es:"Me rompí un hueso.",pt:"Quebrei um osso.",target:"hueso"}]},
{id:"n_tos",type:"noun",tag:"b",word:"la tos",gloss:"tosse",sentences:[{es:"Tengo mucha tos.",pt:"Estou com muita tosse.",target:"tos"}]},
{id:"n_gripe",type:"noun",tag:"a",word:"la gripe",gloss:"gripe",sentences:[{es:"Estoy con gripe.",pt:"Estou com gripe.",target:"gripe"}]},
{id:"n_gafas",type:"noun",tag:"b",word:"las gafas",gloss:"óculos",sentences:[{es:"No encuentro las gafas.",pt:"Não acho os óculos.",target:"gafas"}]},
/* -- Roupa & objetos -- */
{id:"n_vaqueros",type:"noun",tag:"b",word:"los vaqueros",gloss:"calça jeans (Espanha)",sentences:[{es:"Llevo unos vaqueros.",pt:"Estou de jeans.",target:"vaqueros"}]},
{id:"n_gorra",type:"noun",tag:"b",word:"la gorra",gloss:"boné",sentences:[{es:"Ponte la gorra, hace sol.",pt:"Põe o boné, está sol.",target:"gorra"}]},
{id:"n_guantes",type:"noun",tag:"b",word:"los guantes",gloss:"luvas",sentences:[{es:"Necesito guantes en invierno.",pt:"Preciso de luvas no inverno.",target:"guantes"}]},
{id:"n_bufanda",type:"noun",tag:"b",word:"la bufanda",gloss:"cachecol",sentences:[{es:"Una bufanda de lana.",pt:"Um cachecol de lã.",target:"bufanda"}]},
{id:"n_cinturon",type:"noun",tag:"b",word:"el cinturón",gloss:"cinto",sentences:[{es:"Abróchate el cinturón.",pt:"Aperta o cinto.",target:"cinturón"}]},
{id:"n_anillo",type:"noun",tag:"b",word:"el anillo",gloss:"anel",sentences:[{es:"Lleva un anillo de oro.",pt:"Usa um anel de ouro.",target:"anillo"}]},
{id:"n_paraguas",type:"noun",tag:"b",word:"el paraguas",gloss:"guarda-chuva",sentences:[{es:"Coge el paraguas.",pt:"Pega o guarda-chuva.",target:"paraguas"}]},
{id:"n_mochila",type:"noun",tag:"g",word:"la mochila",gloss:"mochila",sentences:[{es:"Llevo la mochila al colegio.",pt:"Levo a mochila pra escola.",target:"mochila"}]},
/* -- Trabalho & estudo -- */
{id:"n_boli",type:"noun",tag:"b",word:"el boli",gloss:"caneta (Espanha, coloq.)",sentences:[{es:"¿Me dejas un boli?",pt:"Me empresta uma caneta?",target:"boli"}]},
{id:"n_lapiz",type:"noun",tag:"b",word:"el lápiz",gloss:"lápis",sentences:[{es:"Escribe con lápiz.",pt:"Escreve a lápis.",target:"lápiz"}]},
{id:"n_cuaderno",type:"noun",tag:"b",word:"el cuaderno",gloss:"caderno",sentences:[{es:"Apunto en el cuaderno.",pt:"Anoto no caderno.",target:"cuaderno"}]},
{id:"n_pagina",type:"noun",tag:"a",word:"la página",gloss:"página",sentences:[{es:"Abre la página diez.",pt:"Abre a página dez.",target:"página"}]},
{id:"n_frase",type:"noun",tag:"g",word:"la frase",gloss:"frase",sentences:[{es:"Repite la frase.",pt:"Repete a frase.",target:"frase"}]},
{id:"n_nota",type:"noun",tag:"g",word:"la nota",gloss:"nota (recado / conceito)",sentences:[{es:"Saqué buena nota.",pt:"Tirei uma boa nota.",target:"nota"}]},
{id:"n_vacaciones",type:"noun",tag:"b",word:"las vacaciones",gloss:"férias",note:"🔵 sempre no plural: <span class='es'>las vacaciones</span>.",sentences:[{es:"Estoy de vacaciones.",pt:"Estou de férias.",target:"vacaciones"}]},
{id:"n_descanso",type:"noun",tag:"a",word:"el descanso",gloss:"pausa / descanso",sentences:[{es:"Hacemos un descanso.",pt:"Vamos fazer uma pausa.",target:"descanso"}]},
{id:"n_cliente",type:"noun",tag:"g",word:"el cliente",gloss:"cliente",sentences:[{es:"El cliente tiene razón.",pt:"O cliente tem razão.",target:"cliente"}]},
{id:"n_negocio",type:"noun",tag:"a",word:"el negocio",gloss:"negócio",sentences:[{es:"Tiene su propio negocio.",pt:"Ele tem o próprio negócio.",target:"negocio"}]},
/* -- Natureza & animais -- */
{id:"n_animal",type:"noun",tag:"g",word:"el animal",gloss:"animal",sentences:[{es:"Me encantan los animales.",pt:"Adoro animais.",target:"animales"}]},
{id:"n_gato",type:"noun",tag:"g",word:"el gato",gloss:"gato",sentences:[{es:"Tengo un gato negro.",pt:"Tenho um gato preto.",target:"gato"}]},
{id:"n_pajaro",type:"noun",tag:"b",word:"el pájaro",gloss:"pássaro",sentences:[{es:"Los pájaros cantan.",pt:"Os pássaros cantam.",target:"pájaros"}]},
{id:"n_pez",type:"noun",tag:"b",word:"el pez",gloss:"peixe (vivo)",note:"🔵 pez = peixe vivo; peixe de comer é <span class='es'>pescado</span>.",sentences:[{es:"Hay peces en el río.",pt:"Tem peixes no rio.",target:"peces"}]},
{id:"n_caballo",type:"noun",tag:"b",word:"el caballo",gloss:"cavalo",sentences:[{es:"Monta a caballo.",pt:"Anda a cavalo.",target:"caballo"}]},
{id:"n_flor",type:"noun",tag:"g",word:"la flor",gloss:"flor",sentences:[{es:"Te compro flores.",pt:"Te compro flores.",target:"flores"}]},
{id:"n_planta",type:"noun",tag:"g",word:"la planta",gloss:"planta (tb. andar)",note:"🔵 planta = planta E andar de prédio (primera planta = 1º andar).",sentences:[{es:"Riego las plantas.",pt:"Rego as plantas.",target:"plantas"}]},
{id:"n_hoja",type:"noun",tag:"b",word:"la hoja",gloss:"folha (planta e papel)",sentences:[{es:"Una hoja de papel.",pt:"Uma folha de papel.",target:"hoja"}]},
{id:"n_piedra",type:"noun",tag:"b",word:"la piedra",gloss:"pedra",sentences:[{es:"Hay una piedra en el zapato.",pt:"Tem uma pedra no sapato.",target:"piedra"}]},
{id:"n_rio",type:"noun",tag:"b",word:"el río",gloss:"rio",sentences:[{es:"Nadamos en el río.",pt:"Nadamos no rio.",target:"río"}]},
{id:"n_bosque",type:"noun",tag:"b",word:"el bosque",gloss:"floresta / mata",sentences:[{es:"Paseamos por el bosque.",pt:"Passeamos pela floresta.",target:"bosque"}]},
{id:"n_campo",type:"noun",tag:"g",word:"el campo",gloss:"campo / interior",sentences:[{es:"Los fines de semana voy al campo.",pt:"Nos fins de semana vou pro interior.",target:"campo"}]},
{id:"n_luna",type:"noun",tag:"b",word:"la luna",gloss:"lua",sentences:[{es:"Hoy hay luna llena.",pt:"Hoje tem lua cheia.",target:"luna"}]},
{id:"n_estrella",type:"noun",tag:"b",word:"la estrella",gloss:"estrela",sentences:[{es:"Se ven las estrellas.",pt:"Dá pra ver as estrelas.",target:"estrellas"}]},
{id:"n_fuego",type:"noun",tag:"b",word:"el fuego",gloss:"fogo",sentences:[{es:"¿Tienes fuego?",pt:"Você tem fogo?",target:"fuego"}]},
{id:"n_tierra",type:"noun",tag:"b",word:"la tierra",gloss:"terra / chão",sentences:[{es:"Se cayó a la tierra.",pt:"Caiu no chão.",target:"tierra"}]},
/* -- Abstratos frequentes -- */
{id:"n_idea",type:"noun",tag:"a",word:"la idea",gloss:"ideia",sentences:[{es:"Es una buena idea.",pt:"É uma boa ideia.",target:"idea"}]},
{id:"n_problema",type:"noun",tag:"g",word:"el problema",gloss:"problema",note:"🔵 masculino: «el problema».",sentences:[{es:"No hay problema.",pt:"Não tem problema.",target:"problema"}]},
{id:"n_solucion",type:"noun",tag:"b",word:"la solución",gloss:"solução",sentences:[{es:"Hay que buscar una solución.",pt:"É preciso achar uma solução.",target:"solución"}]},
{id:"n_error",type:"noun",tag:"b",word:"el error",gloss:"erro",sentences:[{es:"Fue un error mío.",pt:"Foi um erro meu.",target:"error"}]},
{id:"n_mentira",type:"noun",tag:"g",word:"la mentira",gloss:"mentira",sentences:[{es:"Eso es mentira.",pt:"Isso é mentira.",target:"mentira"}]},
{id:"n_amor",type:"noun",tag:"g",word:"el amor",gloss:"amor",sentences:[{es:"Es el amor de mi vida.",pt:"É o amor da minha vida.",target:"amor"}]},
{id:"n_muerte",type:"noun",tag:"b",word:"la muerte",gloss:"morte",sentences:[{es:"Le tiene miedo a la muerte.",pt:"Ele tem medo da morte.",target:"muerte"}]},
{id:"n_salud",type:"noun",tag:"b",word:"la salud",gloss:"saúde",sentences:[{es:"La salud es lo primero.",pt:"A saúde vem em primeiro lugar.",target:"salud"}]},
{id:"n_historia",type:"noun",tag:"a",word:"la historia",gloss:"história",sentences:[{es:"Cuéntame la historia.",pt:"Me conta a história.",target:"historia"}]},
{id:"n_noticia",type:"noun",tag:"b",word:"la noticia",gloss:"notícia",sentences:[{es:"Tengo buenas noticias.",pt:"Tenho boas notícias.",target:"noticias"}]},
{id:"n_cambio",type:"noun",tag:"b",word:"el cambio",gloss:"troco / mudança",note:"🔵 cambio = troco E mudança. «Quédate con el cambio» = fica com o troco.",sentences:[{es:"Quédate con el cambio.",pt:"Fica com o troco.",target:"cambio"}]},
{id:"n_tema",type:"noun",tag:"g",word:"el tema",gloss:"tema / assunto",note:"🔵 masculino: «el tema».",sentences:[{es:"Cambiemos de tema.",pt:"Vamos mudar de assunto.",target:"tema"}]},
{id:"n_minuto",type:"noun",tag:"g",word:"el minuto",gloss:"minuto",sentences:[{es:"Espera un minuto.",pt:"Espera um minuto.",target:"minuto"}]},
{id:"n_final",type:"noun",tag:"g",word:"el final",gloss:"final / fim",sentences:[{es:"Al final todo salió bien.",pt:"No fim deu tudo certo.",target:"final"}]},
{id:"n_reloj",type:"noun",tag:"b",word:"el reloj",gloss:"relógio",sentences:[{es:"Mi reloj se paró.",pt:"Meu relógio parou.",target:"reloj"}]},
{id:"n_palabra",type:"noun",tag:"b",word:"la palabra",gloss:"palavra",sentences:[{es:"No entiendo esta palabra.",pt:"Não entendo esta palavra.",target:"palabra"}]},
{id:"n_regalo",type:"noun",tag:"b",word:"el regalo",gloss:"presente (que se dá)",sentences:[{es:"Te traje un regalo.",pt:"Te trouxe um presente.",target:"regalo"}]},
{id:"n_mando",type:"noun",tag:"b",word:"el mando",gloss:"controle remoto (Espanha)",sentences:[{es:"¿Dónde está el mando?",pt:"Onde está o controle?",target:"mando"}]},
{id:"n_cana",type:"noun",tag:"b",word:"la caña",gloss:"chopinho (Espanha)",note:"🔵 <span class='es'>una caña</span> = um chope pequeno tirado (clássico dos bares na Espanha).",sentences:[{es:"Ponme una caña.",pt:"Me vê um chope.",target:"caña"}]},
{id:"n_aseos",type:"noun",tag:"b",word:"los aseos",gloss:"banheiros (público)",sentences:[{es:"¿Dónde están los aseos?",pt:"Onde ficam os banheiros?",target:"aseos"}]},
{id:"n_edad",type:"noun",tag:"b",word:"la edad",gloss:"idade",sentences:[{es:"¿Qué edad tienes?",pt:"Quantos anos você tem?",target:"edad"}]},
{id:"n_ejemplo",type:"noun",tag:"g",word:"el ejemplo",gloss:"exemplo",sentences:[{es:"Dame un ejemplo.",pt:"Me dá um exemplo.",target:"ejemplo"}]},

/* ===== ADJETIVOS · lote 2 ===== */
{id:"aj_pobre",type:"adjetivo",tag:"g",word:"pobre",gloss:"pobre",sentences:[{es:"Es una familia pobre.",pt:"É uma família pobre.",target:"pobre"}]},
{id:"aj_debil",type:"adjetivo",tag:"b",word:"débil",gloss:"fraco",sentences:[{es:"Me siento débil.",pt:"Me sinto fraco.",target:"débil"}]},
{id:"aj_duro",type:"adjetivo",tag:"g",word:"duro/a",gloss:"duro",sentences:[{es:"La cama es muy dura.",pt:"A cama é muito dura.",target:"dura"}]},
{id:"aj_blando",type:"adjetivo",tag:"b",word:"blando/a",gloss:"mole / macio",sentences:[{es:"El pan está blando.",pt:"O pão está macio.",target:"blando"}]},
{id:"aj_ligero",type:"adjetivo",tag:"b",word:"ligero/a",gloss:"leve",sentences:[{es:"Una cena ligera.",pt:"Um jantar leve.",target:"ligera"}]},
{id:"aj_pesado",type:"adjetivo",tag:"r",word:"pesado/a",gloss:"pesado / chato (pessoa)",note:"🔴 pesado = pesado E chato (pessoa insistente): «no seas pesado».",sentences:[{es:"La maleta es muy pesada.",pt:"A mala é muito pesada.",target:"pesada"}]},
{id:"aj_frio",type:"adjetivo",tag:"a",word:"frío/a",gloss:"frio",sentences:[{es:"El agua está fría.",pt:"A água está fria.",target:"fría"}]},
{id:"aj_seco",type:"adjetivo",tag:"g",word:"seco/a",gloss:"seco",sentences:[{es:"La ropa ya está seca.",pt:"A roupa já está seca.",target:"seca"}]},
{id:"aj_mojado",type:"adjetivo",tag:"b",word:"mojado/a",gloss:"molhado",sentences:[{es:"El suelo está mojado.",pt:"O chão está molhado.",target:"mojado"}]},
{id:"aj_claro",type:"adjetivo",tag:"g",word:"claro/a",gloss:"claro",sentences:[{es:"Está muy claro.",pt:"Está bem claro.",target:"claro"}]},
{id:"aj_verdadero",type:"adjetivo",tag:"a",word:"verdadero/a",gloss:"verdadeiro",sentences:[{es:"Es una historia verdadera.",pt:"É uma história verdadeira.",target:"verdadera"}]},
{id:"aj_falso",type:"adjetivo",tag:"g",word:"falso/a",gloss:"falso",sentences:[{es:"Es un billete falso.",pt:"É uma nota falsa.",target:"falso"}]},
{id:"aj_cierto",type:"adjetivo",tag:"b",word:"cierto/a",gloss:"certo / verdadeiro",note:"🔵 <span class='es'>eso es cierto</span> = isso é verdade.",sentences:[{es:"Eso es cierto.",pt:"Isso é verdade.",target:"cierto"}]},
{id:"aj_seguro",type:"adjetivo",tag:"g",word:"seguro/a",gloss:"seguro / certo",sentences:[{es:"¿Estás seguro?",pt:"Você tem certeza?",target:"seguro"}]},
{id:"aj_posible",type:"adjetivo",tag:"a",word:"posible",gloss:"possível",sentences:[{es:"Es posible.",pt:"É possível.",target:"posible"}]},
{id:"aj_imposible",type:"adjetivo",tag:"a",word:"imposible",gloss:"impossível",sentences:[{es:"Es imposible.",pt:"É impossível.",target:"imposible"}]},
{id:"aj_necesario",type:"adjetivo",tag:"a",word:"necesario/a",gloss:"necessário",sentences:[{es:"No es necesario.",pt:"Não é necessário.",target:"necesario"}]},
{id:"aj_util",type:"adjetivo",tag:"a",word:"útil",gloss:"útil",sentences:[{es:"Es muy útil.",pt:"É muito útil.",target:"útil"}]},
{id:"aj_inutil",type:"adjetivo",tag:"a",word:"inútil",gloss:"inútil",sentences:[{es:"Es inútil intentarlo.",pt:"É inútil tentar.",target:"inútil"}]},
{id:"aj_sencillo",type:"adjetivo",tag:"b",word:"sencillo/a",gloss:"simples",sentences:[{es:"Es muy sencillo.",pt:"É muito simples.",target:"sencillo"}]},
{id:"aj_complicado",type:"adjetivo",tag:"g",word:"complicado/a",gloss:"complicado",sentences:[{es:"Es un poco complicado.",pt:"É um pouco complicado.",target:"complicado"}]},
{id:"aj_normal",type:"adjetivo",tag:"g",word:"normal",gloss:"normal",sentences:[{es:"Es normal sentirse así.",pt:"É normal se sentir assim.",target:"normal"}]},
{id:"aj_especial",type:"adjetivo",tag:"g",word:"especial",gloss:"especial",sentences:[{es:"Es un día especial.",pt:"É um dia especial.",target:"especial"}]},
{id:"aj_diferente",type:"adjetivo",tag:"g",word:"diferente",gloss:"diferente",sentences:[{es:"Es diferente.",pt:"É diferente.",target:"diferente"}]},
{id:"aj_distinto",type:"adjetivo",tag:"b",word:"distinto/a",gloss:"diferente / distinto",note:"🔵 distinto = diferente. Em PT «distinto» (elegante) é <span class='es'>elegante</span>.",sentences:[{es:"Es algo distinto.",pt:"É algo diferente.",target:"distinto"}]},
{id:"aj_parecido",type:"adjetivo",tag:"g",word:"parecido/a",gloss:"parecido / semelhante",sentences:[{es:"Somos muy parecidos.",pt:"Somos muito parecidos.",target:"parecidos"}]},
{id:"aj_igual",type:"adjetivo",tag:"g",word:"igual",gloss:"igual",sentences:[{es:"Son iguales.",pt:"São iguais.",target:"iguales"}]},
{id:"aj_mismo",type:"adjetivo",tag:"b",word:"mismo/a",gloss:"mesmo / próprio",sentences:[{es:"Es lo mismo.",pt:"É a mesma coisa.",target:"mismo"}]},
{id:"aj_propio",type:"adjetivo",tag:"b",word:"propio/a",gloss:"próprio",sentences:[{es:"Tiene su propio coche.",pt:"Ele tem o próprio carro.",target:"propio"}]},
{id:"aj_ultimo",type:"adjetivo",tag:"g",word:"último/a",gloss:"último",sentences:[{es:"Es la última vez.",pt:"É a última vez.",target:"última"}]},
{id:"aj_primero",type:"adjetivo",tag:"a",word:"primero/a",gloss:"primeiro",sentences:[{es:"Es la primera vez.",pt:"É a primeira vez.",target:"primera"}]},
{id:"aj_proximo",type:"adjetivo",tag:"g",word:"próximo/a",gloss:"próximo",sentences:[{es:"El próximo mes.",pt:"O próximo mês.",target:"próximo"}]},
{id:"aj_siguiente",type:"adjetivo",tag:"b",word:"siguiente",gloss:"seguinte",sentences:[{es:"Al día siguiente.",pt:"No dia seguinte.",target:"siguiente"}]},
{id:"aj_medio",type:"adjetivo",tag:"b",word:"medio/a",gloss:"meio / metade",sentences:[{es:"Media hora.",pt:"Meia hora.",target:"Media"}]},
{id:"aj_entero",type:"adjetivo",tag:"b",word:"entero/a",gloss:"inteiro",sentences:[{es:"Me comí el pan entero.",pt:"Comi o pão inteiro.",target:"entero"}]},
{id:"aj_doble",type:"adjetivo",tag:"b",word:"doble",gloss:"dobro / duplo / de casal",sentences:[{es:"Una habitación doble.",pt:"Um quarto de casal.",target:"doble"}]},
{id:"aj_amable",type:"adjetivo",tag:"b",word:"amable",gloss:"gentil / amável",sentences:[{es:"Es muy amable.",pt:"Ele é muito gentil.",target:"amable"}]},
{id:"aj_antipatico",type:"adjetivo",tag:"g",word:"antipático/a",gloss:"antipático",sentences:[{es:"Es un poco antipático.",pt:"Ele é um pouco antipático.",target:"antipático"}]},
{id:"aj_educado",type:"adjetivo",tag:"g",word:"educado/a",gloss:"educado",sentences:[{es:"Es un niño muy educado.",pt:"É um menino muito educado.",target:"educado"}]},
{id:"aj_grosero",type:"adjetivo",tag:"b",word:"grosero/a",gloss:"grosseiro / mal-educado",sentences:[{es:"No seas grosero.",pt:"Não seja grosseiro.",target:"grosero"}]},
{id:"aj_inteligente",type:"adjetivo",tag:"g",word:"inteligente",gloss:"inteligente",sentences:[{es:"Es muy inteligente.",pt:"Ele é muito inteligente.",target:"inteligente"}]},
{id:"aj_tonto",type:"adjetivo",tag:"b",word:"tonto/a",gloss:"bobo / idiota",sentences:[{es:"No seas tonto.",pt:"Não seja bobo.",target:"tonto"}]},
{id:"aj_loco",type:"adjetivo",tag:"b",word:"loco/a",gloss:"louco / doido",sentences:[{es:"¿Estás loco?",pt:"Você está louco?",target:"loco"}]},
{id:"aj_serio",type:"adjetivo",tag:"a",word:"serio/a",gloss:"sério",sentences:[{es:"Es una persona seria.",pt:"É uma pessoa séria.",target:"seria"}]},
{id:"aj_gracioso",type:"adjetivo",tag:"r",word:"gracioso/a",gloss:"engraçado",note:"🔴 <b>Falso amigo:</b> gracioso = engraçado. «Gracioso (elegante)» é <span class='es'>elegante</span>.",sentences:[{es:"Es muy gracioso.",pt:"Ele é muito engraçado.",target:"gracioso"}]},
{id:"aj_aburrido",type:"adjetivo",tag:"r",word:"aburrido/a",gloss:"chato / entediado",note:"🔴 <b>Falso amigo:</b> ser aburrido = ser chato; estar aburrido = estar entediado.",sentences:[{es:"La película es aburrida.",pt:"O filme é chato.",target:"aburrida"}]},
{id:"aj_divertido",type:"adjetivo",tag:"g",word:"divertido/a",gloss:"divertido",sentences:[{es:"Fue una noche divertida.",pt:"Foi uma noite divertida.",target:"divertida"}]},
{id:"aj_interesante",type:"adjetivo",tag:"a",word:"interesante",gloss:"interessante",sentences:[{es:"Es un libro interesante.",pt:"É um livro interessante.",target:"interesante"}]},
{id:"aj_fresco",type:"adjetivo",tag:"r",word:"fresco/a",gloss:"fresco / atrevido",note:"🔴 fresco = fresco (temperatura/comida) E atrevido/descarado (pessoa).",sentences:[{es:"El pescado está fresco.",pt:"O peixe está fresco.",target:"fresco"}]},
{id:"aj_dulce",type:"adjetivo",tag:"b",word:"dulce",gloss:"doce",sentences:[{es:"El café está muy dulce.",pt:"O café está muito doce.",target:"dulce"}]},
{id:"aj_salado",type:"adjetivo",tag:"a",word:"salado/a",gloss:"salgado",sentences:[{es:"Está muy salado.",pt:"Está muito salgado.",target:"salado"}]},
{id:"aj_picante",type:"adjetivo",tag:"g",word:"picante",gloss:"apimentado / picante",sentences:[{es:"La comida está picante.",pt:"A comida está apimentada.",target:"picante"}]},
{id:"aj_maduro",type:"adjetivo",tag:"g",word:"maduro/a",gloss:"maduro",sentences:[{es:"El plátano está maduro.",pt:"A banana está madura.",target:"maduro"}]},
{id:"aj_guay",type:"adjetivo",tag:"b",word:"guay",gloss:"legal / massa (Espanha)",sentences:[{es:"¡Qué guay!",pt:"Que legal!",target:"guay"}]},
{id:"aj_corto",type:"adjetivo",tag:"a",word:"corto/a",gloss:"curto",sentences:[{es:"Tiene el pelo corto.",pt:"Ela tem o cabelo curto.",target:"corto"}]},
